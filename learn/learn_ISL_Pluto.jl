...
# ╔═╡ ac662ea0-44f8-11ee-36f4-c974b88f9249
md"""
# 1 Introduction
* [An Introduction to Statistical Lernaing](https://www.statlearning.com/)
* [Applications in Julia](https://juliaai.github.io/DataScienceTutorials.jl/)
...
# ╔═╡ e7bfbbab-738d-4088-8dbd-ba3cdd8c24b8
md"""
## This Book
...
* Matrix ``X``, see page 10
### Organization of This Book
* Ch2: K-nearest neighbor
* Ch3: linear regression
* Ch4: logistic regression, linear discriminant analysis
* Ch5: cross-validation, bootstrap
* Ch6: linear methods, stepwise selection, ridge regression, principal components, lasso
* Ch7: non-linear additive models
* Ch8: tree-based methods, bagging, boosting, random forests
* Ch9: support vector machines
* Ch10: deep learning
* Ch11: survival analysis
* Ch12: unsupervised, principal components anslysis, K-means clustering, hierarchical clustering
* Ch13: multiple hypothesis testing
### Data Sets Used in Labs and Exercises
See Table 1.1, data are in the ISLR2 library.
### [Book Website](https://www.statlearning.com)

"""

# ╔═╡ d47e92f2-a66c-4357-ad8c-54af0350793e
md"""
# 2 Statistical Learning
## 2.1 What Is Statistical Learning?
* ``X``, input variables, predictors, independent variables, features
* ``X_i``, individual input variable
* ``Y``, output variable, response, dependent variable

$Y = f(X) + \epsilon$
"""

# ╔═╡ 176542a9-ea71-47df-b730-27dc2efa025a
md"""
...
* ``\hat{Y}=f(X)``, reducible error
* ``\epsilon``, irreducible error
* Equation 2.3
* ``E()^2``, average or expected value
* minimizing th reducible error
* ``\epsilon``, upper bound, unknown

#### Inference
* Which predictors are associated with the response?  The important one.
* What is the relationship between the response and each predictor?
* Can the relationship between ``Y`` and each predictor linear or more complicated?

See examples of prediction vs. inference on page 20.
"""

# ╔═╡ 1c7aef9d-3299-4dd1-8b0c-cb79dc8cf849
md"""
### 2.1.2 How Do We Estimate ``f\,``?
* Shared characteristics among methods
* training data
* ``Y \approx \hat{f}(X)``
* parametric, non-parametric
#### Parametric Methods
* functional form, linear model, overfitting, least square
#### Non-Parametric Methods
* a very large number of ovservations is required
* thin-plate spline
...
# ╔═╡ b0ee9561-c6dc-408a-a53b-2365218c4896
md"""
## 2.2 Assessing Model Accuracy
### 2.2.1 Measuring the Quality of Fit
mean squared error

$\text{MSE} = \frac{1}{n}\sum_{i=1}^{n}(y_i - \hat{f}(x_i))^2\;\;\;(2.5)$

* training MSE vs. test MSE

test observations

$\text{Ave}(y_0 - \hat{f}(x_0))^2\;\;\;(2.6)$

* cross-validation
"""

# ╔═╡ d929623f-8227-421e-be04-cb757ff4f183
md"""
...
* ``E(y_0-\hat{f}(x_0))^2``, expected test MSE at ``x_0``, refers to the average test MSE
* variance of ``\hat{f}(x_0)``
* squared bias of ``\hat{f}(x_0)``
* variance of the error, ``\epsilon``
* (2.7) is called **bias-variance trade-off**
...
* estimate ``\hat{f}``, **training error rate**

$\frac{1}{n}\sum_{i=1}^{n}I(y_i\ne\hat{y}_i)\;\;\;(2.8)$

* ``I``, indicator variable
* ``I(y_i \ne \hat{y}_i) = 1``, if ``y_i \ne \hat{y}_i``
* ``I(y_i \ne \hat{y}_i) = 0``, if ``y_i = \hat{y}_i``
...
$\text{Pr}(Y=j | X = x_0)\;\;\;\;(2.10)$

orange area, ``\text{Pr}(Y=\text{orange} | X) > 50\%``, purple dashed line, probability = 50%, **Bayes desision boundary**

* Bayes classifier produces the lowest test error rate

Bayes error rate

$1 - E(\max_{j}\text{Pr}(Y=j|X)) \;\;\;(2.11)$
"""

# ╔═╡ 12a78276-2b64-40d9-802f-cbc151cd270a
md"""
#### K-Nearest Neighbors
* do not know the conditional distribution of Y given X
...
Follow [Data Science Tutorials](https://juliaai.github.io/DataScienceTutorials.jl/isl/lab-2/)
### 2.3.1 Basic commands
[Basic commands](https://juliaai.github.io/DataScienceTutorials.jl/isl/lab-2/#basic_commands)
...
md"""
### 2.3.2 Loading data
[Loading data](https://juliaai.github.io/DataScienceTutorials.jl/isl/lab-2/#loading_data)
"""

# ╔═╡ 132e0b5e-19a4-431a-a303-747c0e45d0c4
auto = let
	auto = dataset("ISLR", "Auto") # DataFrame
	first(auto,3)
