...
# ╔═╡ e870113e-4c9e-4efd-bd6b-7f68c541be6d
using MLJ

# ╔═╡ bd98e207-07ed-4b17-b1c3-eadc048712e2
using PrettyTables

# ╔═╡ 17a908e6-e9d3-4eb5-b890-54d0873cc5a5
using DataFrames

# ╔═╡ 1bfdc4fb-b91b-4cc9-8e84-408c813b18c8
html"""<style>
main {
    max-width: 90%;
    margin-left: 8%;
...
# ╔═╡ 74499a6d-2b59-4a49-9699-6a22938ae514
md"""
# Getting Started
## Choosing and evaluating a model
"""

# ╔═╡ 8595ebd7-d581-43a9-aaaf-4c7bc491496e
function html_table(x)
	HTML(pretty_table(String, x; backend=Val(:html)))
end;

# ╔═╡ e34ca4c0-0e76-4ce3-b954-23f4b04e3bbc
begin
	iris = load_iris()
	selectrows(iris, 1:3) |> html_table
end

# ╔═╡ b74a1b8f-b94c-49d6-ab59-41de98ce5e3a
schema(iris) |> html_table

# ╔═╡ 73b8ac47-b200-4369-8587-31ab88a924a0
begin
	iris_df = DataFrame(iris);
	y,X = unpack(iris, ==(:target);rng=123)
	X = DataFrame(X)
	first(X, 3) |> html_table
end

# ╔═╡ cfbc8e48-600d-451e-87c2-9b1a9f34dcdc
models(matching(X,y))

# ╔═╡ 759e39f3-a3bf-425f-8ee2-ad0598708d20
doc("DecisionTreeClassifier", pkg="DecisionTree");

# ╔═╡ 94a6cc27-52bc-4633-84f0-06f69393c125
import MLJDecisionTreeInterface

# ╔═╡ 8a87792b-9718-4ff5-abdb-eb916261bbe5
Tree = @load DecisionTreeClassifier pkg=DecisionTree verbosity=0;

# ╔═╡ 556b7057-5298-4c4a-b84c-4eeda4b4de8a
tree = Tree()

# ╔═╡ bd4bd5a8-c9ca-4a9f-a834-6acc1ff080a3
evaluate(tree, X, y, resampling=CV(shuffle=true), measures=[log_loss, accuracy], verbosity=0)

# ╔═╡ e8d7b474-5771-49e9-a1f4-86b32cd71a88
md"""
## A preview of data type specification in MLJ
"""

# ╔═╡ c98d2202-49fa-47b4-9c7d-559cca99e431
typeof(y)

# ╔═╡ 7586a484-9d33-4ff1-b3df-051690b566c5
target_scitype(tree)

# ╔═╡ 5fcdb236-e125-47f7-8cb0-8867a34d028b
subtypes(Finite)

# ╔═╡ c7865c2a-ffde-4cb2-a3ca-e2bc21a0cf27
scitype(y)

# ╔═╡ b11923f4-5531-461a-bf0e-dd43a32d4c6f
yint = int.(y);

# ╔═╡ 57a3ea02-0425-4d90-8c4e-ea12368e4583
md"""
## Fit and predict
"""
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "d93861b2a2af0926cac4086acf5ea1462f99eb54"
...
git-tree-sha1 = "1c20aaf741638fc6e185d7ded132b71ebe201cbc"
